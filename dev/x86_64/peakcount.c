...
#define tm1 tm1_PeakCount
 double tm1 = 0;
#define vm2 vm2_PeakCount
 double vm2 = 0;
#define vm1 vm1_PeakCount
 double vm1 = 0;
 ...
 "vm1_PeakCount", &vm1_PeakCount,
 "vm2_PeakCount", &vm2_PeakCount,
 "tm1_PeakCount", &tm1_PeakCount,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 PeakCount /home/heitor/Dropbox/Unicamp/reproducible/dev/x86_64/peakcount.mod\n");
...
/*VERBATIM*/
 ...
 net_send ( _tqitem, (double*)0, _ppvar[1]._pvoid, t +  firing , 3.0 ) ;
   check ( _threadargs_ ) ;
   }
